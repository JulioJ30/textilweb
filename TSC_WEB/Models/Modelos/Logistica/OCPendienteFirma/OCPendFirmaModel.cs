    ...
    public class OCPendFirmaModel
    {
        ...
        public MemoryStream ReporteExcel(List<Lista4_ListaExcel> listado)
        {
            ...
            using (var package = new ExcelPackage(stream))
            {
                ...
                workSheet.Cells["C1"].Value = "FIRMAS";
                workSheet.Cells["D1"].Value = "CECO";
                ...
                workSheet.Cells["J1"].Value = "FIRMANTE PENDIENTE";
                workSheet.Cells["K1"].Value = "FIRMA 1";
                workSheet.Cells["L1"].Value = "FIRMA 2";
                workSheet.Cells["M1"].Value = "FIRMA 3";
                ...
                workSheet.Column(5).Width = 25;     // DESCRIPCION PAGO
                workSheet.Column(6).Width = 30;     // PROVEEDOR";
                workSheet.Column(7).Width = 30;     // COMPRADOR";
                workSheet.Column(8).Width = 15;     // MONEDA";
                workSheet.Column(9).Width = 15;     // TOTAL OC";
                workSheet.Column(10).Width = 50;     // FIRMA PENDIENTE";
                workSheet.Column(11).Width = 8;     // FIRMA 1";
                workSheet.Column(12).Width = 8;     // FIRMA 2";
                workSheet.Column(13).Width = 8;     // FIRMA 3";
                ...
                foreach (var item in listado)
                {
                    ...
                    workSheet.Cells[i, 4].Value = item.CECO;
                    ...
                    workSheet.Cells[i, 10].Value = item.FIRMANTE;
                    workSheet.Cells[i, 11].Value = item.FIRMA_1;
                    workSheet.Cells[i, 12].Value = item.FIRMA_2;
                    workSheet.Cells[i, 13].Value = item.FIRMA_3;
